...
val StepPalettes: List<StepPalette> = listOf(
    StepPalette("tide", "Tide", Color(0xFF00A88E), TideLight, TideDark),
    StepPalette("zen", "Zen", Color(0xFF445E91), ZenLight, ZenDark),
    StepPalette("ember", "Ember", Color(0xFFB4552D), EmberLight, EmberDark),
    StepPalette("forest", "Forest", Color(0xFF3B6939), ForestLight, ForestDark)
)

fun paletteById(id: String): StepPalette = StepPalettes.firstOrNull { it.id == id } ?: StepPalettes.first()
